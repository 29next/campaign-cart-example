...
async function main() {
    try {
        ...
        const newSlug = await askQuestion('\nEnter new campaign slug (e.g., product-v2): ');
        ...
        const newName = await askQuestion('Enter new campaign name (e.g., Product V2): ');
        ...
        console.log(`\n💡 Run "npm run start" to start working on your new campaign\n`);
